...
CREATE TABLE branch(branchNo char(5) PRIMARY KEY,street varchar(35),city varchar(10),postcode varchar(10));INSERT INTO branch VALUES("B005","22 Deer Rd","London","SW1 4EH");
...
CREATE TABLE staff(staffNo char(5) PRIMARY KEY,fName varchar(10),lName varchar(10),position varchar(10),sex char(1),DOB date,salary int,branchNo char(5));
...
CREATE TABLE privateOwner(ownerNo char(5) PRIMARY KEY,fName varchar(10),lName varchar(10),address varchar(50),telNo char(15),email varchar(50),password varchar(40));
...
INSERT INTO privateOwner VALUES("CO40","Tina","Murphy","63 Well St. Glasgow G42","0141-943-1728", "tinam@hotmail.com", null);INSERT INTO privateOwner VALUES("CO93","Tony","Shaw","12 Park Pl. Glasgow G4 0QR","0141-225-7025", "tony.shaw@ark.com", null);

DROP TABLE IF EXISTS propertyForRent;
CREATE TABLE propertyForRent(propertyNo char(5) PRIMARY KEY,street varchar(35),city varchar(10),postcode varchar(10),type varchar(10),rooms smallint,rent int,ownerNo char(5) not null,staffNo char(5),branchNo char(5));
...
CREATE TABLE client(clientNo char(5) PRIMARY KEY,fName varchar(10),lName varchar(10),telNo char(15),prefType varchar(10),maxRent int,email varchar(50));
...
CREATE TABLE  viewing(clientNo char(5) not null,propertyNo char(5) not null,viewDate date,comment varchar(15));
...
CREATE TABLE registration(clientNo char(5) not null,branchNo char(5) not null,staffNo char(5) not null,dateJoined date);
